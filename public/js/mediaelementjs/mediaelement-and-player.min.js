...
(function ($) {
	...
	mejs.MepDefaults = {
		...
		videoHeight: -1,
		// follow container height (only if height 100%)
		followContainerHeight: false,		
	...
	mejs.MediaElementPlayer.prototype = {
		...
		setPlayerSize: function(width,height) {
			...
			// detect 100% mode - use currentStyle for IE since css() doesn't return percentages
      		if (t.height.toString().indexOf('%') > 0 || t.$node.css('max-width') === '100%' || parseInt(t.$node.css('max-width').replace(/px/,''), 10) / t.$node.offsetParent().width() === 1 || (t.$node[0].currentStyle && t.$node[0].currentStyle.maxWidth === '100%')) {
				...
				if(height === '100%' && t.options.followContainerHeight) {
		...
		setControlsSize: function() {
			...
			if (railWidth === 0 || !railWidth) {
				...
				railWidth = t.controls.width() - usedWidth - (rail.outerWidth(true) - rail.width()) - 3;
			}
		...
		buildoverlays: function(player, controls, layers, media) {
			...
			if(mejs.MediaFeatures.isiOS) {
				wrapAnchorVideo = $('.fslandingslider').parent().find('video source[type="video/ogg"]')[0].src;
			}

            if(wrapAnchorVideo && $('#videoTopAnchor')[0]) $('#videoTopAnchor').attr('href', wrapAnchorVideo);
			...
			*/
			...
			media.addEventListener('play',function() {
                ...
                $('.video-fallback').hide();
                $('.mejs-controls').hide();
                $('.fslandingslider').hide();
                $('.parallaxoverlay').hide();
			}, false);
			...
			media.addEventListener('pause',function() {
                ...
                $('.video-fallback').show();
                //$('.mejs-controls').show();
                $('.fslandingslider').show();
                $('.parallaxoverlay').show();
			}, false);
